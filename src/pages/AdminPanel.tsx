  ...
  return (
    <AdminNavbar>
      ...
      >
        ...
        <Box sx={{ my: { xs: 3, md: 0 } }}>
          <div dangerouslySetInnerHTML={{ __html: `<lottie-player src="/portfolio_front1/Admin.json" background="transparent" speed="1" style="width:100%;max-width:625px;height:auto;" loop autoplay></lottie-player>` }} />
        </Box>
